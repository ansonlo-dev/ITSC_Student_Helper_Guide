...
<video src="https://github.com/ansonlo-dev/ITSC_Student_Helper_Guide/blob/main/docs/public/videos/media1.mp4" controls></video>
- **刪除預訂** —— 在日曆中打開自己的預訂並移除。每次請假都必須自行完成這一步。
<video src="https://github.com/ansonlo-dev/ITSC_Student_Helper_Guide/blob/main/docs/public/videos/media2.mp4" controls></video>
