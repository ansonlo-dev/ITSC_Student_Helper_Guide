...
5. **簽退** —— [ics.ln.edu.hk/helper](https://ics.ln.edu.hk/helper)

::: warning 步驟由系統強制執行
沒有預訂更份就無法簽到；沒有提交檢查結果就無法簽退。漏做第 1 步或第 4 步，系統
都會攔截。
:::
...
<video src="https://github.com/ansonlo-dev/ITSC_Student_Helper_Guide/raw/refs/heads/main/docs/public/videos/media1.mp4" controls="controls" muted="muted" style="max-width: 100%;"></video>
- **刪除預訂** —— 在日曆中打開自己的預訂並移除。每次請假都必須自行完成這一步。
<video src="https://github.com/ansonlo-dev/ITSC_Student_Helper_Guide/raw/refs/heads/main/docs/public/videos/media2.mp4" controls="controls" muted="muted" style="max-width: 100%;"></video>
...
**電腦室：** SEKG02、SEKG03、SEK105、MB202、LBY301、LBY303、LCH201、LCH202、
...
每項職務都有自己的檢查表。請在[職務](/zh-TW/duties/)下找出對應的一項。

## 5. 簽退

如果你在提交結果之前嘗試簽退，頁面會以紅字顯示尚未完成的工作，例如：
...
忘記簽到或簽退、重複簽到、簽退時間錯誤，或者超時工作？請填寫
**「Abnormal sign in+out」** Excel 檔案，記錄以下內容：
